...
SET @weekdays_json	= '{ "sunday":1, "monday":2, "tuesday":3, "wednesday":4, "thursday":5, "friday":6, "saturday":7 }'
...
SELECT
	...
	, weeks_json		= NULL
	, weekdays_json		= '{"sunday":1,"monday":2,"tuesday":3,"wednesday":4,"thursday":5,"friday":6,"saturday":7}'
	, months_json		= NULL
	, created_by		= 'rnadimpalli'
	, created_stamp		= GETDATE()
	, modified_by		= 'rnadimpalli'
...
SELECT
	...
	, days_json			= NULL
	, weeks_json		= NULL
	, weekdays_json		= '{"monday":2,"tuesday":3,"wednesday":4,"thursday":5,"friday":6,"saturday":7}'
	, months_json		= NULL
	, created_by		= 'rnadimpalli'
	, created_stamp		= GETDATE()
	, modified_by		= 'rnadimpalli'
